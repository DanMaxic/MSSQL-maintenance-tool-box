...
top 500
	...
	,[Avg Rows]		=cast(ROUND(	(total_rows)/(execution_count+0.0),2) as decimal(20,3))
	,[max_rows]		=cast(ROUND(	(max_rows),2) as decimal(20,3))
...
where 
	cast(ROUND(	((total_worker_time)+0.0)/(execution_count*1000000) ,2)as decimal(20,3)) >0.02
	AND 
	qt.dbid <>10
ORDER BY 5 desc
...
CROSS APPLY 
	...
	*/
	...
	where 
	--OBJECT_NAME(p.object_id,p.database_id) =@ProcName
